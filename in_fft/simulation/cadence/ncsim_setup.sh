...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twi3.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twr2.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twi4.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twr3.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twr4.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twi2.hex ./
  cp -f $QSYS_SIMDIR/submodules/in_fft_fft_ii_0_opt_twr1.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/in_fft_fft_ii_0.sv"     -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/in_fft.v"                                                                            
fi
